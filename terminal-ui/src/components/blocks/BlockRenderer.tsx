...
export function BlockRenderer({ block, noMargin }: BlockRendererProps) {
  ...
  switch (renderType) {
    case "api":
      return (
        <ApiBlock title={block.title} body={block.body} noMargin={noMargin} />
      );
    case "phase":
    ...
    case "code":
      return (
        <CodeBlock title={block.title} body={block.body} noMargin={noMargin} />
      );
    case "json":
      return (
        <JsonBlock title={block.title} body={block.body} noMargin={noMargin} />
      );
    case "table":
      return (
        <TableBlock title={block.title} body={block.body} noMargin={noMargin} />
      );
    case "bullet":
      return (
        <BulletBlock
    ...
    case "quote":
      return (
        <QuoteBlock title={block.title} body={block.body} noMargin={noMargin} />
      );
    case "heading":
      return (
        <HeadingBlock
    ...
    case "link":
      return (
        <LinkBlock title={block.title} body={block.body} noMargin={noMargin} />
      );
    case "key_value":
      return (
        <KeyValueBlock
    ...
    case "diff":
      return (
        <DiffBlock title={block.title} body={block.body} noMargin={noMargin} />
      );
    case "terminal":
      return (
        <TerminalBlock
